...
DEFAULT_CONFIG = {
    ...
    "providers": {
        ...
        MemoryType.LIGHTWEIGHT_MEMORY: {
            ...
            "max_shortterm_items": 8,
            "shortterm_provision_interval": 8,
            "shortterm_extraction_interval": 3,
            "min_shortterm_delta_chars": 250,
            "simple_task_memory_delay_steps": 6,
            "top_k_longterm": 1,
            "enable_longterm_provision": True,
            "longterm_min_confidence": 0.55,
            "longterm_candidate_limit": 12,
            "begin_memory_budget_chars": 700,
            "in_memory_budget_chars": 500,
